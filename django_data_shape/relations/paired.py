...
class Paired:
    ...
    :class:`~django_data_shape.relations.fan_out.FanOut` declarations are refused beside
    ...
    **The second side's marginal is derived, not declared, and that is on
    ...
    def parents(self) -> tuple[object, ...] | None:
        ...
        The same narrowing
        :class:`~django_data_shape.relations.fan_out.FanOut` takes, and it is here for the
