...
class WorldChanged(Exception):
    ...
    :class:`~django_data_shape.declaration.invalid_shape.InvalidShape`: the declaration is
    ...
    Raised by :func:`~django_data_shape.relations.fan_out_sizes.fan_out_sizes`, which
